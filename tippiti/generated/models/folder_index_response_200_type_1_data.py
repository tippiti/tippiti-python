...
T = TypeVar("T", bound="FolderIndexResponse200Type1Data")



@_attrs_define
class FolderIndexResponse200Type1Data:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        folder_index_response_200_type_1_data = cls(
            folders=folders,
            permission_folders=permission_folders,
        )


        folder_index_response_200_type_1_data.additional_properties = d
        return folder_index_response_200_type_1_data
