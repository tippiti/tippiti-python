...
T = TypeVar("T", bound="DictationVersionRejectResponse422")



@_attrs_define
class DictationVersionRejectResponse422:
    """ 
        Attributes:
            success (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dictation_version_reject_response_422 = cls(
            success=success,
            message=message,
            errors=errors,
        )
        ...
        dictation_version_reject_response_422.additional_properties = d
        return dictation_version_reject_response_422
