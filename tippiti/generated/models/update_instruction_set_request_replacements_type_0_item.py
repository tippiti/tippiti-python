...
T = TypeVar("T", bound="UpdateInstructionSetRequestReplacementsType0Item")



@_attrs_define
class UpdateInstructionSetRequestReplacementsType0Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_instruction_set_request_replacements_type_0_item = cls(
            id=id,
            search=search,
            replace=replace,
        ...
        update_instruction_set_request_replacements_type_0_item.additional_properties = d
        return update_instruction_set_request_replacements_type_0_item
