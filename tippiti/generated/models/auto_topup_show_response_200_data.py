...
T = TypeVar("T", bound="AutoTopupShowResponse200Data")



@_attrs_define
class AutoTopupShowResponse200Data:
    """ 
        Attributes:
            enabled (bool):
            threshold (int | None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auto_topup_show_response_200_data = cls(
            enabled=enabled,
            threshold=threshold,
            amount=amount,
            payment_method_id=payment_method_id,
        ...
        auto_topup_show_response_200_data.additional_properties = d
        return auto_topup_show_response_200_data
