...
T = TypeVar("T", bound="StoreDictationNoteRequest")



@_attrs_define
class StoreDictationNoteRequest:
    """ 
        Attributes:
            content (str):
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.is_important, Unset):
            files.append(("is_important", (None, str(self.is_important).encode(), "text/plain")))



        if not isinstance(self.show_on_top, Unset):
            files.append(("show_on_top", (None, str(self.show_on_top).encode(), "text/plain")))
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        store_dictation_note_request = cls(
            content=content,
        ...
        store_dictation_note_request.additional_properties = d
        return store_dictation_note_request
