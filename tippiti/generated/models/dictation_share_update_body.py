...
T = TypeVar("T", bound="DictationShareUpdateBody")



@_attrs_define
class DictationShareUpdateBody:
    """ 
        Attributes:
            password (None | str | Unset):
            remove_password (bool | Unset):
            allow_delete (bool | Unset):
            allow_archive (bool | Unset):
            show_notes (bool | Unset):
            expires_at (datetime.datetime | None | Unset):
            remove_expiry (bool | Unset):
     """

    password: None | str | Unset = UNSET
    remove_password: bool | Unset = UNSET
    allow_delete: bool | Unset = UNSET
    allow_archive: bool | Unset = UNSET
    show_notes: bool | Unset = UNSET
    expires_at: datetime.datetime | None | Unset = UNSET
    remove_expiry: bool | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if remove_password is not UNSET:
            field_dict["remove_password"] = remove_password
        ...
        if remove_expiry is not UNSET:
            field_dict["remove_expiry"] = remove_expiry
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_password = d.pop("remove_password", UNSET)
        ...
        remove_expiry = d.pop("remove_expiry", UNSET)

        dictation_share_update_body = cls(
            password=password,
        ...
        dictation_share_update_body.additional_properties = d
        return dictation_share_update_body
